...
const portfolioItems = [
  ...
  },
  {
    ...
    detailedDescription: `
      صفحة منتج بطاقة NFC الذكية تم تطويرها لعرض وبيع منتجات تقنية NFC المتطورة.
      تتميز الصفحة بتصميم عصري وجذاب يركز على عرض مميزات وفوائد بطاقات NFC بطريقة واضحة ومفهومة.

      تم تصميم الصفحة لتحقق أعلى معدلات التحويل من خلال عرض المنتج بطريقة احترافية وتقديم تجربة تسوق سلسة.
      تحتوي على معارض صور تفاعلية، وصف تفصيلي للمنتج، ونظام طلب مبسط وسهل الاستخدام.
    `,
    features: [
      "عرض تفاعلي لمميزات بطاقة NFC",
      "معرض صور عالي الجودة للمنتج",
      "نظام طلب وشراء مبسط",
      "دعم للدفع الإلكتروني المتعدد",
      "تصميم متجاوب لجميع الأجهزة",
      "تحسين لمحركات البحث والتحويل"
    ]
  }
]
