        ...
        <div className="hero-content text-center max-w-6xl mx-auto">
          ...
          >
            <span className="text-white">
              ...
              <span className="bg-gradient-to-r from-wakkelni-cyan to-wakkelni-purple bg-clip-text text-transparent">احصل على صفحة هبوط
              </span> أو Funnel يطبع أرباح ويفوق أداء صفحاتك الحالية خلال 
              <span className="bg-gradient-to-r from-wakkelni-cyan to-wakkelni-purple bg-clip-text text-transparent">٧ أيام فقط
              </span>
            </span>
          </h1>
